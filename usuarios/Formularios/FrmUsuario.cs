...
namespace usuarios.Formularios
{
    public partial class FrmUsuario : Form
    {
        ...
        private string validations(Usuario usuario)
        {
            ...
            {
                if (string.IsNullOrEmpty(usuario.usu_password) || string.IsNullOrEmpty(txtClaveConfirmar.Text))
                {
            ...
            if (!string.IsNullOrEmpty(txtClave.Text) && !string.IsNullOrEmpty(txtClaveConfirmar.Text))
            {
